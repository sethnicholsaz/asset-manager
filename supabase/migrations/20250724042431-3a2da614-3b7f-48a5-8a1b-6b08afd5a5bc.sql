-- Truncate all cow-related data again for fresh testing of enhanced disposition processing
...
INSERT INTO monthly_processing_log (
  ...
  0,
  0,
  'All cow data truncated for testing enhanced disposition processing with depreciation catch-up'
);