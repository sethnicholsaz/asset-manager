-- Drop and recreate the functions to handle processing_mode

-- Drop existing functions
DROP FUNCTION IF EXISTS public.fetch_depreciation_settings(uuid);
DROP FUNCTION IF EXISTS public.upsert_depreciation_settings(uuid, text, integer, numeric, boolean, integer, boolean, boolean, integer, integer);

-- Recreate fetch_depreciation_settings with processing_mode
...
-- Recreate upsert_depreciation_settings with processing_mode
