-- Truncate all cow-related data for clean re-upload test with optimized acquisition journals
-- This will allow us to test the new batch acquisition journal creation
