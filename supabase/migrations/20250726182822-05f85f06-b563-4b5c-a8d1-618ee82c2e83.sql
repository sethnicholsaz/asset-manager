-- Update the depreciation settings functions to handle processing_mode

-- Update fetch_depreciation_settings to include processing_mode
...
-- Update upsert_depreciation_settings to include processing_mode
