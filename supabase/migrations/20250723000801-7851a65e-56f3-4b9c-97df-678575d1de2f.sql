-- Fix the ambiguous reference by using the variable name explicitly
...
DECLARE
  ...
  cow_record RECORD;
  new_journal_entry_id UUID; -- Rename variable to avoid ambiguity
...
BEGIN
  ...
  -- Update disposition with journal entry ID - use the renamed variable
