-- Fix the ambiguous column reference in process_monthly_depreciation_with_mode function
-- The journal_entry_id column reference is ambiguous and needs to be qualified
