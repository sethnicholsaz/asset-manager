-- Create a simplified version of the monthly depreciation function to test basic functionality
-- This removes the complex processing log to isolate the core depreciation logic
