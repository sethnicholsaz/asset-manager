-- Fix the enhanced disposition function to properly handle existing partial month depreciation entries
-- The function is trying to create duplicate entries when they already exist
