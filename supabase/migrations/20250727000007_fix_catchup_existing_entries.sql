-- Fix the catchup function to properly handle existing journal entries
-- The current function is trying to create duplicate entries when they already exist
