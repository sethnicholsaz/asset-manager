-- Fix disposition processing to include historical depreciation catchup
-- This ensures all depreciation entries exist up to the disposition date before creating the disposition journal
...
GRANT EXECUTE ON FUNCTION public.process_disposition_journal_enhanced TO anon, authenticated; 