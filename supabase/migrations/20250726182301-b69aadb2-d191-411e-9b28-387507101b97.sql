-- Add support for historical vs production mode in depreciation processing

-- First, update the monthly depreciation function to support processing modes
...
-- Update historical processing to use the new mode-aware function
