-- Fix the catch_up_cow_depreciation_to_date function to include the round_to_nearest_dollar field
-- The function was failing because it wasn't selecting the round_to_nearest_dollar field from depreciation_settings
