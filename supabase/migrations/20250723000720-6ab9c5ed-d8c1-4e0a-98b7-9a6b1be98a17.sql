-- Fix the ambiguous column reference in the UPDATE statement of process_disposition_journal
...
DECLARE
  ...
  gain_loss NUMERIC;
BEGIN
  -- Get disposition details - fix ambiguous column references
  ...
  -- Update disposition with journal entry ID - fix the ambiguous reference
  UPDATE cow_dispositions 
  SET journal_entry_id = journal_entry_id  -- Use the local variable
